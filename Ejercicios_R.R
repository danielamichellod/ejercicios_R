...
# Enunciado: Utiliza las funciones class e is.numeric para determinar el tipo
# de dato de numero.
...
# Enunciado: Realiza una operación aritmética que sume numero y el doble
# de numero.
...
informacion <- list(nombre = "Laura", edad = 25)
informacion

# Ejercicio 5: Funciones is.character e is.logical
# Enunciado: Verifica si nombre es de tipo caracter y si es_numerico es de 
# tipo lógico.
...
# Enunciado: Crear una variable llamada mayor_de_edad que sea TRUE si la edad
...
# Enunciado: Utiliza el operador %in% para verificar si el valor 30 está
# presente en el vector edades.
